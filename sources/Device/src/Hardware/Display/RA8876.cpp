...
void RA8876_SDRAM_Init (void)
{
	...
	LCD_RegisterWrite(0xe2, (uint8)sdram_itv);
	LCD_RegisterWrite(0xe3, (uint8)(sdram_itv >>8));
...
void Frame_Buffer_Start_Address(unsigned long Addr)	
{
	...
	*/
	LCD_RegisterWrite(0x20, (uint8)Addr);
	LCD_RegisterWrite(0x21, (uint8)(Addr >> 8));
	LCD_RegisterWrite(0x22, (uint8)(Addr >> 16));
...
void Frame_Buffer_Width(unsigned short WX)	
{
	...
	*/
	LCD_RegisterWrite(0x24, (uint8)WX);
...
void Frame_Buffer_Start_XY(unsigned short WX,unsigned short HY)	
{
	...
	*/
	LCD_RegisterWrite(0x26, (uint8)WX);
	LCD_RegisterWrite(0x27, (uint8)(WX >> 8));

	LCD_RegisterWrite(0x28, (uint8)HY);
	LCD_RegisterWrite(0x29, (uint8)(HY >> 8));
}
//[2Ah][2Bh][2Ch][2Dh]=========================================================================
void PIP_Display_Start_XY(unsigned short WX,unsigned short HY)	
{
	...
	Function bit will be configured for relative PIP window.
	*/
	LCD_RegisterWrite(0x2A, (uint8)WX);
	LCD_RegisterWrite(0x2B, (uint8)(WX >> 8));
	
	LCD_RegisterWrite(0x2C, (uint8)HY);
	LCD_RegisterWrite(0x2D, (uint8)(HY >> 8));
}
//[2Eh][2Fh][30h][31h]=========================================================================
void PIP_Image_Start_Address(unsigned long Addr)	
{
	...
	*/
	LCD_RegisterWrite(0x2E, (uint8)Addr);
	LCD_RegisterWrite(0x2F, (uint8)(Addr >> 8));
	LCD_RegisterWrite(0x30, (uint8)(Addr >> 16));
...
void PIP_Image_Width(unsigned short WX)	
{
	...
	Function bit will be configured for relative PIP window.
	*/
	LCD_RegisterWrite(0x32, (uint8)WX);
...
void PIP_Window_Image_Start_XY(unsigned short WX,unsigned short HY)	
{
	...
	Function bit will be configured for relative PIP window.
	*/
	LCD_RegisterWrite(0x34, (uint8)WX);
	LCD_RegisterWrite(0x35, WX >> 8);
	
	LCD_RegisterWrite(0x36, (uint8)HY);
...
void PIP_Window_Width_Height(unsigned short WX,unsigned short HY)	
{
	...
	Function bit will be configured for relative PIP window.
	*/
	LCD_RegisterWrite(0x38, (uint8)WX);
	LCD_RegisterWrite(0x39, WX >> 8);
	
	LCD_RegisterWrite(0x3A, (uint8)HY);
...
void Graphic_Cursor_XY (unsigned short WX,unsigned short HY)
{
	...
	Reference main Window coordination.
	*/	
	LCD_RegisterWrite(0x40,(uint8)WX);
	LCD_RegisterWrite(0x41,WX>>8);

	LCD_RegisterWrite(0x42,(uint8)HY);
...
void Canvas_Window_Start_Address (unsigned long Addr)	
{
	...
	*/
	LCD_RegisterWrite(0x50,(uint8)Addr);
	LCD_RegisterWrite(0x51,(uint8)(Addr>>8));
	LCD_RegisterWrite(0x52,(uint8)(Addr>>16));
...
void Canvas_Window_Width (unsigned short WX)	
{
	...
	*/
	LCD_RegisterWrite(0x54,(uint8)WX);
...
void Canvas_Window_Start_XY (unsigned short WX,unsigned short HY)	
{
	...
	*/
	LCD_RegisterWrite(0x56,(uint8)WX);
	LCD_RegisterWrite(0x57,WX>>8);
	
	LCD_RegisterWrite(0x58,(uint8)HY);
...
void Canvas_Window_WH (unsigned short WX,unsigned short HY)	
{
	...
	*/
	LCD_RegisterWrite(0x5A,(uint8)WX);
	LCD_RegisterWrite(0x5B,WX>>8);
 
 	LCD_RegisterWrite(0x5C,(uint8)HY);
...
void Goto_Pixel_XY(unsigned short WX,unsigned short HY)	
{
	...
	*/
	LCD_RegisterWrite(0x5F,(uint8)WX);
	LCD_RegisterWrite(0x60,WX>>8);
	
	LCD_RegisterWrite(0x61,(uint8)HY);
	LCD_RegisterWrite(0x62,HY>>8);
}

void Goto_Linear_Addr(unsigned long Addr)
{
	LCD_RegisterWrite(0x5F,(uint8)Addr);
	LCD_RegisterWrite(0x60,(uint8)(Addr>>8)); 
	LCD_RegisterWrite(0x61,(uint8)(Addr>>16));
...
void Goto_Text_XY(unsigned short WX,unsigned short HY)	
{
	...
	Unit: Pixel
	*/
	LCD_RegisterWrite(0x63,(uint8)WX);
	LCD_RegisterWrite(0x64,WX>>8);
	
	LCD_RegisterWrite(0x65,(uint8)HY);
...
void BTE_Destination_Window_Start_XY(unsigned short WX,unsigned short HY)	
{
	...
	*/
	LCD_RegisterWrite(0xAD,(uint8)WX);
	LCD_RegisterWrite(0xAE,(uint8)(WX>>8));

	LCD_RegisterWrite(0xAF,(uint8)HY);
	LCD_RegisterWrite(0xB0,(uint8)(HY>>8));
}
