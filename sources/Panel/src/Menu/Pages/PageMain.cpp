...
namespace PageMain
{
    ...
    static void DrawZoneLoadIndication()
    {
        ...
        Text("ÈÍÄÈÊÀÖÈß ÍÀÃÐÓÇÊÈ").Write(rect.X() + 30, rect.Y() + d, Color::BLACK);

        pchar titles[3] = { "ØÏÈÍÄÅËÜ", "ÎÑÜ X", "ÎÑÜ Y" };
    ...
    static void DrawZonePresetX()
    {
        ...
        Text("ÏÐÅÄÍÀÁÎÐ ÊÎÎÐÄÈÍÀÒÛ X").Write(rect.X() + d, rect.Y() + d, Color::BLACK);
    ...
    static void DrawZonePresetY()
    {
        ...
        Text("ÏÐÅÄÍÀÁÎÐ ÊÎÎÐÄÈÍÀÒÛ Y").Write(rect.X() + d, rect.Y() + d, Color::BLACK);
    ...
    static void DrawZonePreset()
    {
        ...
        Text("ÏÐÅÄÍÀÁÎÐ").Write(rect.X() + d, rect.Y() + d, Color::BLACK);
    }
    ...
    static void Func_Draw()
    {
        ...
        DrawZoneLoadIndication();       // Èíäèêàöèÿ íàãðóçêè
