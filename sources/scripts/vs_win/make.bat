...
:MAKE
    ...
    cd scripts/vs_win
    if %1==debug ( @echo on & cmake ../../VS/CMakeLists.txt -B../../generated/GUI -G "Visual Studio 17 2022" -A Win32 )
    @echo off
    if %1==release ( @echo on & cmake ../../VS/CMakeLists.txt -B../../generated/GUI -G "Visual Studio 17 2022" -A Win32 -DBUILD_USE_STATIC_RUNTIME=ON )
    @echo off
    @echo %TIME%   Complete
    exit /b
