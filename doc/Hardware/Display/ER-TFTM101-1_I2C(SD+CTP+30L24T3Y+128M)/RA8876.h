...
sbit  	SCL=P1^1;	//I2C CLK
sbit  	SDA=P1^0;	//  I2C SDA
sbit next  =P3^5;		//next
sbit rst  =P3^7;	//RESET	

bit 	ack;	

#define write_data_addr  0xfe  //slave addresses with write data
#define read_data_addr  0xff  //slave addresses with read data
#define write_cmd_addr  0xfc  //slave addresses with write command
#define read_STU_addr  0xfd  //slave addresses with read status
